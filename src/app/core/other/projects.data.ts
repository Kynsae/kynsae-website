...
export const PROJECTS_DATA: readonly Project[] = [
  ...
  },
  {
    ...
    medias: [
      ...
      { type: 'image', url: 'projects/lighter-model/2.webp'},
      { type: 'image', url: 'projects/lighter-model/3.webp'},
      { type: 'image', url: 'projects/lighter-model/4.webp'},
      { type: 'image', url: 'projects/lighter-model/5.webp'},
      { type: 'image', url: 'projects/lighter-model/6.webp'},
      { type: 'image', url: 'projects/lighter-model/7.webp'},
      { type: 'image', url: 'projects/lighter-model/8.webp'},
    ],
    year: '2026'
  },
];